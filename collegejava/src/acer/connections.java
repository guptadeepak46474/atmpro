...
//            c = DriverManager.getConnection("jdbc:mysql:///project7","root","sushmavijay@123apple");
//            s =c.createStatement();
//
//
//        }catch(Exception e){
...
public class connections {
    ...
    public static Connection connect()
    {
        try {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost/mysql?user=root&password=sushmavijay@123apple")) {
